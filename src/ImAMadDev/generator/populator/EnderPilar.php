...
namespace ImAMadDev\generator\populator;
...
class EnderPilar implements Populator
{
    ...
    private function getWorkableBlockAt(Chunk $chunk, int $x, int $z): int {
        $air = VanillaBlocks::AIR()->getFullId();
        for($y = EndGenerator::MAX_BASE_ISLAND_HEIGHT, $maxY = EndGenerator::MAX_BASE_ISLAND_HEIGHT + EndGenerator::NOISE_SIZE; $y <= $maxY; ++$y ) {
