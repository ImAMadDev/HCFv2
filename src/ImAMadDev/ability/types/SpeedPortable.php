...
class SpeedPortable extends Ability {
	...
	public function get(int $count = 1, mixed $value = null): Item {
		$item = ItemFactory::getInstance()->get(ItemIds::SUGAR, 0, $count);
	...
	public function consume(HCFPlayer $player) : void {
		...
		$effect = new EffectInstance(VanillaEffects::SPEED(), (20 * 10), 3, true);
	...
	public function getColoredName() : string {
		return TextFormat::colorize("&aSpeed Portable&r");
	}
