...
class TopTwo extends NPCEntity
{
    ...
    public function getName() : string {
        if (isset(HCF::getInstance()->getTopKills()[1])) return TextFormat::GOLD ."Top #2" . TextFormat::EOL .
            TextFormat::AQUA . HCF::getInstance()->getTopKills()[1]["name"] . TextFormat::EOL .
            TextFormat::RED . "Kills: " . HCF::getInstance()->getTopKills()[1]["kills"] . TextFormat::EOL;
        return TextFormat::GOLD . "Top #2" . TextFormat::EOL .
